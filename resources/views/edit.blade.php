...
<div class="card">
    ...
    <form class="card-body" action="{{ route('update') }}" method="POST">
        ...
        <div class="form-check form-check-inline mb-3">
            {{-- 3項演算子 → if分を1行で書く方法 {{条件 ? trueだったら : falseだったら}} --}}
            {{-- もし$include_tagsにループで回っているタグのidが含まれれば、chekedを書く --}}
        ...
        <button style="display: block;" type="submit" class="btn btn-primary">更新</button>
    </form>
</div>
@endsection